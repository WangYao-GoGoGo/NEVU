...
def main():
    ...
    #         "--train_hv",
    #         "/home/iiserver32/Workbench/wang_yao/echv/formal/experimental_dataset/dataset/train_sub_gold.json",
    #         "--dev_event",
    #         "/home/iiserver32/Workbench/wang_yao/echv/formal/experimental_dataset/dataset/dev_dataset_total_formatted.json",
    #         "--dev_hv",
    #         "/home/iiserver32/Workbench/wang_yao/echv/formal/experimental_dataset/dataset/dev_sub_gold.json",
    #         "--test_event",
    #         "/home/iiserver32/Workbench/wang_yao/echv/formal/experimental_dataset/dataset/test_dataset_total_formatted.json",
    #         "--test_hv",
    #         "/home/iiserver32/Workbench/wang_yao/echv/formal/experimental_dataset/dataset/adjudicated/test_gold_major_released_union.json",
    ...
    #         "--sample_seed", "42",
    #         "--out_dir",
    #         "/home/iiserver32/Workbench/wang_yao/echv/echv_experiment/G3/outputs/microsoft/Phi-3.5-MoE-instruct/debug_lora_ckpt",
    #         "--pred_out",
    #         "/home/iiserver32/Workbench/wang_yao/echv/echv_experiment/G3/outputs/microsoft/Phi-3.5-MoE-instruct/debug_lora_ckpt/test_pred.json",
    #         "--report_out",
    #         "/home/iiserver32/Workbench/wang_yao/echv/echv_experiment/G3/outputs/microsoft/Phi-3.5-MoE-instruct/debug_lora_ckpt/debug_report.json",
    #         "--pred_out_dev",
    #         "/home/iiserver32/Workbench/wang_yao/echv/echv_experiment/G3/outputs/microsoft/Phi-3.5-MoE-instruct/debug_lora_ckpt/dev_test_pred.json",
    #         "--report_out_dev",
    #         "/home/iiserver32/Workbench/wang_yao/echv/echv_experiment/G3/outputs/microsoft/Phi-3.5-MoE-instruct/debug_lora_ckpt/debug_dev_report.json",
    #         "--g1_evaluate_only", "y",
    #     ]
    ...
    #         "--group", "G4",
    #
    #         # G4 不用真正的 LLM model_name，但为了输出目录清楚，给一个名字
    ...
    #         "--sample_seed", "42",
    #
    #         # 固定输出目录，避免时间戳覆盖你手写 pred_out/report_out
    #         "--use_timestamp", "0",
    #
    #         # G4 统一输出根目录
    #         "--out_dir",
    ...
    #
    #         # 不限制输出标签数量。后面如果 precision 太低，可以再加 top_m
    ...
    #
    #         # article-level 默认不直接加入全文，避免 article 太长导致检索噪声
