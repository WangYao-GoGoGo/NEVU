...
"""Controlled Grouping Test runner for heuristic-baseline comparisons.

This variant evaluates models on controlled grouping inputs used to compare
event-centric predictions against heuristic grouping baselines. It reuses the
main LoRA/inference/evaluation pipeline, but builds CGT-specific payloads and
gold labels through ``inference_cgt.py`` and the CGT helpers in
``utils.data_utils``.
"""
...
def main():
    ...
    if DEBUG:
        sys.argv = [sys.argv[0]] + [
            ...
            "--test_hv",
            "dataset/deep_analysis/test/cgt_BCE_SCE_test_gold.json",
            ...
            "--sample_seed", "42",
            "--out_dir",
            "results/G3/outputs/mistralai/Ministral-3-8B-Instruct-2512_cgt/debug_lora_ckpt",
            "--pred_out",
            "results/G3/outputs/mistralai/Ministral-3-8B-Instruct-2512_cgt/debug_lora_ckpt/test_pred.json",
            "--report_out",
            "results/G3/outputs/mistralai/Ministral-3-8B-Instruct-2512_cgt/debug_lora_ckpt/debug_report.json",
            "--pred_out_dev",
            "results/G3/outputs/mistralai/Ministral-3-8B-Instruct-2512_cgt/debug_lora_ckpt/dev_test_pred.json",
            "--report_out_dev",
            "results/G3/outputs/mistralai/Ministral-3-8B-Instruct-2512_cgt/debug_lora_ckpt/debug_dev_report.json",
            "--g1_evaluate_only", "y",
        ]
    ...
    test_gold = data_utils.list_to_cgt_gold_dict(test_gold)
